    ...
    elseif ($Valida == 'qbttp') {
      ...
      if(@$_POST["enviaEmpregador"]){
       ...
       if ($msg1 == "01+EE+00") {
        ...
        echo '<a class="btn btn-success btn-block" href="R01_E3.php?Sec=1123"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
        echo '</div>';
        ...
        echo '<h4><i class="icon fa fa-ban"></i> Atenção!</h4>';
        echo 'EMPREGADOR ENVIADO, RESPOSTA DO RELÓGIO:<strong>' . $msg1 . '</strong>.';
        echo '<a class="btn btn-success btn-block" href="Ponto8x_E3.php?Sec=1123"><iclass="icon-ok icon-white" >Próximo passo</a> <br /><br />';
        echo '</div>';
       }
     }
   }
