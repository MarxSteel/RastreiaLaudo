  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: <strong>PERIFÉRICOS</strong></li>
     </ol>
    </section>
    <section class="content">
     ...
     <div class="box-body">
        ...
        <tr>
         <div class="col-xs-4">Modelo
          <select class="form-control" name="modelo" id="modelo" required="required">
           ...
           <option value="PLUS">SMART 3G</option>
           <option value="PLUS BIO">PLACA</option>
           <option value="PROT I MOVEL">VIGIA BASTÃO</option>
           <option value="PROT II MOVEL">CONVERSOR TCP/IP</option>
          </select>
         </div>
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_acesso (Modelo, NumSerie, DataCadastro, HoraCadastro, Status, UserCadastro, Observa) VALUES ('$Modelo', '$numREP', '$data', '$hora', '3', '$Nick', '$Obseracao')");
        if($executa)
        {
