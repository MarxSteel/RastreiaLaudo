...
$PDO = db_connect();
 ...
 $query->execute();
  ...
  $MetaRealizada = $row['MetaRealizada'];
    $NovaMeta = $MetaRealizada+1;
  $Montagem = $row['MontOK'];
    $NovaMontagem = $Montagem+1;
  ...
  <div class="content-wrapper">
   <div class="container">
    <section class="content-header">
     <ol class="breadcrumb">
      <li>CADASTRO DE EQUIPAMENTO: Velti Ponto 373</li>
     </ol>
    </section>
    <?php
    if ($Valida == '1123') {
      ...
      echo '<h2 class="box-title"><strong> PASSO 4: </strong>Cadastro</h2>';
      echo '</div>';
      echo '<div class="box-body">';
      echo '<h3 class="page-title">Cadastrando Equipamento</h3>';
      ?>
      <div class="col-xs-12">
      ...
      if(@$_POST["enviar"]){
       ...
       $executa = $PDO->query("INSERT INTO cadastro_373 (Modelo, NumSerie, DataCadastro, HoraCadastro, Status, UserCadastro, LeiMifare, LeiProx, LeiBarras, LeiBio, Firmware, Display, Observa) VALUES ('Velti Ponto 373', '$NumREP', '$data', '$hora', '1', '$Nick', '$Smart', '$Prox', '$Barras', '$Bio', '$Firmware', '$Display', '$Observacao')");
        if($executa)
        {
