   ...
   <div class="container">
    ...
    elseif ($Valida == '1') {
      ...
      <div class='col-xs-8'>
       ...
       <strong><code><?php echo $MIFARE; ?></code></strong><br />
       <strong><code><?php echo $MTeste; ?></code></strong>
      </div>
      <form name="EnvMif" id="EnvMif" method="post" action="" enctype="multipart/form-data">
       <div class='col-xs-12'><br /><br />
        <input name="EnviaMif" type="submit" class="btn btn-danger btn-block btn-lg" id="EnviaMif" value="ENVIAR CARTÕES MIFARE / BARRAS" />
       </div>
     </form>
     <?php
     if(@$_POST["EnviaMif"]){
       $cod_msg = "03+EU+000+1+I[900000000028[TESTE DE FABRICA 3[0[2[" . $MIFARE . "}" . $MTeste;
