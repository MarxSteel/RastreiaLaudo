 ...
 <section class="content">
  ...
  <?php if ($PermAdm === "9") { ?>
   <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
     <form name="ap" id="name" method="post" action="" enctype="multipart/form-data">
     <a href="AvancaPapel.php" >
      <span class="info-box-icon btn-danger">
       <i class="fa fa-map-signs"></i></span>
     </a>
     </form>
     <div class="info-box-content"><h4>Avançar Papel</h4></div>
    </div>
   </div><!-- CLASS ROW -->
  ...
  <?php  include_once 'modalImprime.php'; } else{ ?>
